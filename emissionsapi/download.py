...
# These are public data provided by ESA. There is no real user management and
# we can keep it like this as long as they do not introduce custom user
# accounts.
user = 's5pguest'
password = 's5pguest'
...
def bounding_box_to_wkt(lon1, lat1, lon2, lat2):
    """Convert a bounding boy specified by its top-left and bottom-right
